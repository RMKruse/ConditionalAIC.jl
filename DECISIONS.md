...
tested end-to-end at the `rtol = 1e-6` Level-1 gate because the df inputs differ. A
Level-2 end-to-end weight comparison would absorb the rounding shift into a wider
`atol` band (not yet measured; planned post-`predictma`).
